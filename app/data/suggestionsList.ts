const suggestionsList = {
	HEALTH: [
		"What are some effective ways to improve and maintain overall physical fitness?",
		"How can I boost my immune system and prevent illnesses?",
		"What are some common symptoms of mental health conditions, and when should I seek professional help?",
		"Can you provide tips for maintaining a healthy sleep schedule and improving sleep quality?",
		"How can I manage stress effectively and maintain good mental well-being?",
		"What are the warning signs and prevention strategies for chronic diseases such as diabetes, heart disease, or cancer?",
		"Can you provide guidance on establishing a well-balanced and nutritious diet?",
	],
	FITNESS: [
